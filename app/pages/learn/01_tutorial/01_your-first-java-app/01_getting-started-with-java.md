...
You can download the JDK from different places. [This](https://jdk.java.net/) is a one-stop page that always refers to the latest version of the JDK. Selecting a JDK version listed under the label, "Ready for use" redirects you to a page where you can download the version of the JDK you need.
